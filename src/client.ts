...
import { LicenseCreateRequest, LicenseListQueryParameters, LicenseResponse, LicenseUpdateRequest } from './services/license.types'
import { UserService } from './services/user.service'
import { UserCreateRequest, UserListQueryParameters, UserPasswordUpdateRequest, UserResponse, UserUpdateRequest } from './services/user.types'
...
export class CryptlexWebApiClient {
    ...
    /**
       ...
       */
    createLicense(license: LicenseCreateRequest): Promise<ApiResponse<LicenseResponse>> {
    ...
    /**
       ...
       * @returns {Promise<ApiResponse<LicenseResponse>>} Promise that resolves to the Web API response
       */
    updateLicense(id: string, license: LicenseUpdateRequest): Promise<ApiResponse<LicenseResponse>> {
    ...
    * @returns {Promise<ApiResponse<LicenseResponse>>} Promise that resolves to the Web API response
    ...
    /**
       ...
       */
    getLicenses(page: number, limit: number, parameters?: LicenseListQueryParameters) {
    ...
    * @returns {Promise<ApiResponse<LicenseResponse>>} Promise that resolves to the Web API response
    ...
    /**
       ...
       * @returns {Promise<ApiResponse<LicenseResponse>>} Promise that resolves to the Web API response
       */
    extendLicense(id: string, extensionLength: number): Promise<ApiResponse<LicenseResponse>> {
    ...
    /**
       ...
       * @returns {Promise<ApiResponse<UserResponse[]>>} Promise that resolves to the Web API response
       */
    getUsers(page: number, limit: number, parameters?: UserListQueryParameters): Promise<ApiResponse<UserResponse[]>> {
    ...
    /**
       ...
       * @returns {Promise<ApiResponse<any>>} Promise that resolves to the Web API response
       */
    updateUserPassword(id: string, passwordUpdate: UserPasswordUpdateRequest): Promise<ApiResponse<any>> {

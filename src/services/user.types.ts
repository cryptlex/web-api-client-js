...
export type UserReadOnlyProperties = 'id' | 'createdAt' | 'updatedAt' | 'twoFactorEnabled' | 'googleSsoEnabled' | 'roles' | 'lastLoginAt' | 'lastSeenAt'

/** Schema for creating a User */
export type UserCreateRequest = Omit<UserResponse, UserReadOnlyProperties | 'metadata'> & {

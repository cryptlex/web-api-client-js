...
export class ApiService {
  /**
    ...
    */
  static getList<T>(httpClient: AxiosInstance, urlPath: string, page: number, limit: number, parameters?: QueryParmeters): Promise<ApiResponse<T>> {
    const params = {
      page,
      limit
    }
  ...
  /**
     ...
     * @returns {Promise<ApiResponse<T>>} Promise that resolves to ApiResponse
     */
  static get<T>(httpClient: AxiosInstance, urlPath: string): Promise<ApiResponse<T>> {
  ...
  /**
     ...
     * @returns {Promise<ApiResponse<T>>} Promise that resolves to ApiResponse
     */
  static post<T>(httpClient: AxiosInstance, urlPath: string, body?: RequestBody): Promise<ApiResponse<T>> {
  ...
  /**
     ...
     * @returns {Promise<ApiResponse<T>>} Promise that resolves to ApiResponse
     */
  static patch<T>(httpClient: AxiosInstance, urlPath: string, body: RequestBody): Promise<ApiResponse<T>> {
  ...
  /**
     ...
     * @returns {Promise<ApiResponse<T>>} Promise that resolves to ApiResponse
     */
  static delete(httpClient: AxiosInstance, urlPath: string): Promise<ApiResponse<any>> {
